...
| 從 BlueXP 部署 Connector | 從BlueXP部署Connector時、您需要使用Azure帳戶或服務主體、該用戶必須具有在Azure中部署Connector VM的權限。 | link:task-install-connector-azure-bluexp.html#step-2-create-a-custom-role["設定 Azure 權限"] 

...
+
--
安全區域包括 https://["AWS C2S 和 SC2S"^] 和 https://["Azure IL6."^]
...
如何開始使用標準模式:: 前往 https://["BlueXP 網路型主控台"^] 並註冊。
+
--
...
| 備份與還原 | 支援於 AWS 和 Azure 商業地區。Google Cloud 或中不支援 https://["AWS C2S/SC2S"^] 或 https://["Azure IL6."^] 
...
| 備份與還原 | 僅支援將內部部署 ONTAP 磁碟區備份及還原至 StorageGRID 系統。https://["瞭解如何將內部部署 ONTAP 資料備份至 StorageGRID"^] 

...
| \shttps：//management．azure.microsoft.scCloud \https://login.microsoftonline.microsoft.scloud \https://blob.core.microsoft.scloud \https://core.microsoft.scloud | 管理Azure IL6區域的資源。 

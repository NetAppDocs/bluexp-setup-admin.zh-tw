...
| 管理 AWS 中的資源。確切的端點取決於部署Connector的區域。 https://docs.aws.amazon.com/general/latest/gr/rande.html["如需詳細資料、請參閱AWS文件"^]
...
| \https://support.netapp.com | 以取得授權資訊、並將 AutoSupport 訊息傳送至 NetApp 支援。

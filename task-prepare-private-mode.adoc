...
NOTE: 如果您想在中使用 BlueXP https://["AWS 商業雲端服務（ C2S ）環境"^] 接著、您應遵循說明如何準備、安裝 Connector 及啟動 Cloud Volumes ONTAP 的個別指示。 https://["瞭解如何在 AWS C2S 環境中開始使用 Cloud Volumes ONTAP"^]
...
.步驟
. https://["在專案中啟用下列 Google Cloud API"^]
+

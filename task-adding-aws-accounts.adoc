...
+
新增AWS認證資料至藍圖XP、可讓藍圖XP擁有建立及管理FSXfor ONTAP Sfor的必要權限。 https://["瞭解如何設定FSX for ONTAP Sfor Sfor Sfor的權限"^]
...
+
*** https://["檢視FSXfor ONTAP Sfor Sf哪些 權限"^]
...
如需詳細資訊、請參閱 https://["適用於 Amazon FSX for ONTAP 的 BlueXP 文件"^]

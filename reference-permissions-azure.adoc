...
| 「Microsoft.Network/privateEndpoints/delete"、Microsoft.Compute/availabilitySets/delete"、 | 可讓BlueXP在Cloud Volumes ONTAP 部署失敗或刪除時、從屬於該資源群組的資源中移除資源。 

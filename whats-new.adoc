...
請注意、在 Amazon EC2 執行個體上、必須先使用執行個體中繼資料服務版本 1 （ IMDSv1 ）、才能在 AWS 中手動安裝 Connector 軟體。

https://docs.netapp.com/us-en/bluexp-setup-admin/reference-limitations.html["深入瞭解 AWS 中的 IMDSv1 需求"]。

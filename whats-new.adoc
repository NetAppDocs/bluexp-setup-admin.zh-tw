...
summary: 瞭解BlueXP（前身為Cloud Manager）管理功能的新功能：NetApp帳戶、連接器、雲端供應商認證等。 
---
= 新功能
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
瞭解BlueXP（前身為Cloud Manager）管理功能的新功能：NetApp帳戶、連接器、雲端供應商認證等。
...
+
https://review.docs.netapp.com/us-en/cloud-manager-setup-admin_nov-2022/task-manage-subscriptions.html["瞭解如何管理您的訂閱"^]

...
我們更新了 Azure 的 Connector 原則、以納入下列權限：
...
* https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/whats-new.html["瞭解 Cloud Volumes ONTAP 對虛擬機器擴充集的支援"^]
...
=== 代理伺服器設定與 Cloud Volumes ONTAP 設定
...
=== 變更 Cloud Volumes ONTAP 的 NSS 帳戶

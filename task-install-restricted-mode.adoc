...
.步驟
. 前往 https://["AWS Marketplace上的BlueXP頁面"^]
...
+
** https://["適用於商業區域的Azure Marketplace頁面"^]
** https://["Azure政府區域的Azure Marketplace頁面"^]
...
+
此設定非常重要、因為託管身分識別可讓 Connector 虛擬機器在 Azure Active Directory 中識別自己、而無需提供任何認證。 https://["深入瞭解 Azure 資源的託管身分識別"^]。

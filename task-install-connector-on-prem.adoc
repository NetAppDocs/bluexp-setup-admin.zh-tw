...
summary: 在內部環境中安裝 Connector 、然後登入並設定以搭配 BlueXP  帳戶使用。 
---
...
[role="lead"]
Connector 是在雲端網路或內部部署網路中執行的 NetApp 軟體、可讓您使用所有 BlueXP  功能和服務。若要在內部環境中執行 Connector 、您需要檢閱主機需求、設定網路、準備雲端權限、安裝 Connector 、設定 Connector 、然後提供您準備的權限。
...
[cols="3*"]
|===
| 連接器版本 | Docker Engine 的最低版本 | Docker Engine 的最大版本 


| _New_ Connector 安裝從 3.9.44 開始 | 23.0.6 | 26.0.0 


| 3.9.44 版本之前建立的連接器 | 23.0.6 | 25.0.5 
|===
+
https://docs.docker.com/engine/install/["檢視 Docker 安裝指示"^]

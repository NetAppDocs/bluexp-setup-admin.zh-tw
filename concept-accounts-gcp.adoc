...
. 部署 Connector 時、系統會提示您選取 https://["服務帳戶"^] 適用於 VM 執行個體。BlueXP 可從服務帳戶取得權限、代表您建立及管理 Cloud Volumes ONTAP 系統等。將自訂角色附加至服務帳戶、即可提供權限。
...
* https://["瞭解如何在 Google Cloud 中部署 Cloud Volumes ONTAP 、並選擇專案"^]

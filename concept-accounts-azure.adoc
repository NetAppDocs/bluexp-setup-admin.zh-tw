...
summary: 瞭解 BlueXP 如何使用 Azure 認證和權限、以便您管理一或多個 Azure 訂閱的認證。例如、您可能想要瞭解如何將額外的 Azure 認證新增至 BlueXP 。 
---
= Azure 認證與權限
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
瞭解 BlueXP 如何使用 Azure 認證和權限、以便您管理一或多個 Azure 訂閱的認證。例如、您可能想要瞭解如何將額外的 Azure 認證新增至 BlueXP 。

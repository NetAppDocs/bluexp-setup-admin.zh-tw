...
summary: 瞭解 BlueXP 如何使用 AWS 認證和權限、以便管理一或多個 AWS 帳戶的認證。例如、您可能想要瞭解如何將額外的 AWS 認證新增至 BlueXP 。 
---
= AWS 認證與權限
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
瞭解 BlueXP 如何使用 AWS 認證和權限、以便管理一或多個 AWS 帳戶的認證。例如、您可能想要瞭解如何將額外的 AWS 認證新增至 BlueXP 。
